            ...
            <div class="auth-box bg-dark border-top border-secondary">
                <div id="loginform">
                        ...
                        <div class="row p-b-30">
                            <div class="col-12">
                                ...
                                <div class="input-group mb-3">
                                    ...
                                    <input type="email" name="email" class="form-control form-control-lg @error('email') is-invalid @enderror" placeholder="Email Address" aria-label="email" aria-describedby="basic-addon1" value="{{ old('email') }}" required autocomplete="email" autofocus>
                                    @error('email')
                    ...
                    <div class="row">
                        <div class="col-md-12 text-center">
                            <a href="{{ route('register') }}" style="color:white">Not yet Registered ? Go to register page</a>
                        </div>
                    </div>
                ...
                <div id="recoverform">
                    <div class="text-center">
                        <span class="text-white">Enter your registered e-mail address below and we will send you reset password link in you email.</span>
                    </div>
                    <div class="row m-t-20">
                        ...
                        <form class="col-12" method="POST" action="{{ route('password.email') }}">
                            ...
                            <div class="input-group mb-3">
                                ...
                                <input type="email" id="email" class="form-control form-control-lg @error('email') is-invalid @enderror" placeholder="Email Address" aria-label="Email" aria-describedby="basic-addon1" name="email" value="{{ old('email') }}" required autocomplete="email" autofocus>
                                @error('email')
                                    <span class="invalid-feedback" role="alert">
                                        <strong>{{ $message }}</strong>
                                    </span>
                            ...
                            <div class="row m-t-20 p-t-20 border-top border-secondary">
                                <div class="col-12">
                                    <a class="btn btn-info float-left" href="#" id="to-login" name="action">Back To Login</a>
                                    <button class="btn btn-success float-right" type="submit" name="action">Send Mail</button>
                                </div>
                            </div>
