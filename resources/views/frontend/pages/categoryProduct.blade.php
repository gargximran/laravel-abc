			...
			<div class="col-md-6 offset-md-3">
				 <form action="{{route('search')}}" method="get">
                    ...
                    <div class="form-group search-product">
                        <input type="text" class="form-control" value="" placeholder="Search your products" name="search">
                        <button type="submit" class="search-btn">Search</button>
                    </div>
				</form>
				<small>Showing result for category: {{$category->name}}</small>
			</div>
		</div>
			...
			<div class="col-md-12">
				<div class="right">
					...
					<div class="row">
                       ...
                       @if (!count($products))
						   <div class="m-5 col-12 text-warning py-5 my-5 text-center alert alert-warning">Sorry We have no product in this category</div>
					   @endif
						<!-- product item start -->
