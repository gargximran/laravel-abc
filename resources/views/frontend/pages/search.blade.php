			...
			<div class="col-md-6 offset-md-3">
				 <form action="{{route('search')}}" method="get">
                    ...
                    <div class="form-group search-product">
                        <input type="text" class="form-control" value="{{$searchQuery}}" placeholder="Search your products" name="search">
                        <button type="submit" class="search-btn">Search</button>
                    </div>
				</form>
				<small>Your search result for : {{$searchQuery}}</small>
			</div>
		</div>
			...
			<div class="col-md-12">
				<div class="right">
					...
					<div class="row">
						...
						@if (!count($products))
							<div class="col-md-12 col-12 text-center my-5 py-5">
								<p class="text-warning">Sorry! We have no product associate with your query..</p>
							</div>
						@endif
