				 ...
				 <div class="form">
						...
						<div class="page slidepage review-order">
								...
								<div class="col-md-12">
									<table>
										...
										<tbody>
                                            ...
                                            @endphp
											<tr>
                                            <td><img src="{{asset('public/images/'.$item->attributes->image)}}" alt="" height="50px" width="50px"></td>
                                                ...
                                                <form action="{{url('/cart/update')}}" method="POST">
													...
													<div class="row">
														<div class="col-md-6">
                                                        <input type="number" value="{{$item->quantity}}" class="number-spin form-control" name="update_qty">
                                                        <input type="hidden" value="{{$item->id}}" class="number-spin form-control" name="id">
														</div>
												...
												<td class="updated-price">
													<p>{{$item->quantity * $item->price}} Taka</p>
												</td>
												<td class="updated-price">
							...
							<div class="row border text-right">
								...
								<div class="col-md-12">
									<h2>total :{{Cart::getSubTotal()}} taka</h2>
								</div>
							</div>
							<!-- total end -->
						...
						<div class="page review-order">
							...
							<div class="row">
								...
								<div class="col-md-12">
									<div class="form-group">
										<label>address</label>
										<input type="text" class="form-control" placeholder="street" name="address" value="{{$customer->address}}" >
