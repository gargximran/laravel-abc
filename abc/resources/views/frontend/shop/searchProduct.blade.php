...
<section class="shop wow bounceIn" data-wow-duration="1s" data-wow-delay="1" style="background-image: url(public/frontend/images/shop.png);">
							...
							<ul>
								...
								<li>
									{{-- <label class="check">cilling fan
                                     ...
                                     --}}
                                      <a href="{{url('/shop/'.$category->slug)}}">{{$category->category_name}}</a> <br>
                                </li>
                                @endforeach
								{{-- <li>
									<label class="check">cilling fan
						...
						<div class="col-md-3 col-6">
							<div class="product-item">
								<div class="product-image">
									...
									<a href="{{url('product/'.$item->slug)}}">add to cart</a>
								</div>
