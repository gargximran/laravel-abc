                            ...
                            <div class="modal-dialog  modal-lg" role="document">
                                        ...
                                        <div class="modal-content">
                                            <div class="modal-header">
                                                <h5 class="modal-title text-center text-primary">Update Business Unit</h5>
                                               
                                            </div>
                                            <div class="modal-body">
                                                <form action="{{route('business_unit_edit', $id->id)}}" method="post" id="addNewForm" enctype="multipart/form-data">
                                                    @csrf
