  ...
  $(".show-mega-menu").click(function(){
    ...
    if( megaMenu != 'all' ){
      ...
      $(document).click(function(divclose){
        if( $(divclose.target).closest(".show-mega-menu").length == 0 && $(divclose.target).closest(".megamenu").length == 0 ){
          $(".megamenu").slideUp();
        }
      })
    }
...
$(document).ready(function(){
	...
	$(document).click(function(divclose){
		if( $(divclose.target).closest(".navbar-ite-mob").length == 0 && $(divclose.target).closest(".show-nav").length == 0 ){
